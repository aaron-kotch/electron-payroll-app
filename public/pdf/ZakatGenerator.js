...
class ZakatGenerator {
    ...
    generateHeader(doc) {
        ...
        .text(`ZAKAT STATEMENT FOR ${this.list[0].month}`, 50, 66)
    ...
    generateTable(doc) {
        ...
        if (item.religion === "Muslim") {
            ...
            .text(item.zakat, epfNoX, currentY)
    ...
    generate() {
        ...
        output.pipe(fs.createWriteStream(`${homeDir}/Desktop/zakat.pdf`))
